<template>
    ...
    <div class="flex flex-row justify-center gap-2 p-4 bg-slate-100 border border-slate-200 rounded-xl">
      <button @click="subtract()" class="p-2 px-4 bg-red-200 hover:bg-red-300 border border-red-300 hover:border-red-400 text-red-500 rounded-lg">-</button>
      <pre class="p-2 border border-slate-300 bg-slate-200 rounded-lg">{{ counter.count }}</pre>
      <button @click="add()" class="p-2 px-4 bg-green-200 hover:bg-green-300 border border-green-300 hover:border-green-400 text-green-500 rounded-lg">+</button>
    </div>
	</div>
